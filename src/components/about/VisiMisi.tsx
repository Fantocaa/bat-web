  ...
  return (
    <>
      <div className="grid grid-cols-2 pt-4 gap-4">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-t from-blueaml-500 opacity-90 z-10 rounded-2xl"></div>
        ...
        <div className="grid grid-rows-3 gap-4">
          ...
          <div className="flex gap-4">
            <div className="bg-white p-6 rounded-2xl w-full flex flex-col justify-end hover:bg-blueaml-500 hover:text-white transition-all duration-200">
